...
function btn_plus(role) {
    if(document.getElementById("more-menu")==null){
        ...
        if(role=="pilote"){
            document.getElementsByClassName("more-menu")[0].insertAdjacentHTML("afterbegin","<ul class='dropdown' id='more-menu'><li><a href='../profil/'>Mon Profil</a></li> \n <li class='dropbtn' id='more_entreprise'>  <p class='p_plus'> &#9668 Gerer Entreprise</p> <ul class='more_more' id='entreprise'><li><a href='../Ajout_Entreprise/'>Ajouter Entreprise</a></li><li><a href='../recherhche_entreprise/'>Chercher une entreprise</a></li></ul></li> \n <li class='dropbtn' id='more_stage'><p class='p_plus'>&#9668 Gerer un Stage </p> <ul  class='more_more' id='stage'><li><a href='../ajout_Stage/'>Ajouter Stage</a></li><li><a href='./pilote/'>Chercher une Offre de Stage</a></li></ul></li>\n <li class='dropbtn' id='more_compte'><a href='../recherche_user/'>Rechercher un étudiant</p></li> \n <li><a href='../wishlist/'>Wish-list</a></li> \n  <li><a href='../assets/phpScripts/deconnexion.php'>Deconnexion</a></li></div>");
            return false;
        }
        if(role=="admin"){
