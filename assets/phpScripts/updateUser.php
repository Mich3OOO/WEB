...
if ($connexion->GetFirstRow("SELECT EXISTS ID_adresse FROM adresse INNER JOIN ville ON ville.idv = adresse.idv WHERE ville = '".$_GET['Ville']."' AND adresseA='".$_GET['Adresse']."';" !==null)){
    ...
    if($connexion->GetFirstRow("SELECT EXISTS idv FROM ville WHERE ville = '".$_GET['Ville']."';" !==null)){
