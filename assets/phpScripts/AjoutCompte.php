<?php
    ...
    if($connexion->GetFirstRow("SELECT NomU FROM utilisateur WHERE NomU = '".$_GET['Nom']."' AND PrenomU ='".$_GET['Prenom']."';")==!null){
        echo 'Utilisateur déjà existant'; 
    } else {
        if($connexion->GetFirstRow("SELECT adresseA FROM adresse INNER JOIN ville ON ville.idv = adresse.idv WHERE adresseA ='".$_GET['Adresse']."' AND ville = '".$_GET['Ville']."';")==!null){
